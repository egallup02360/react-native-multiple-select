        ...
        {selector ? (
          ...
          >
            ...
            >
              ...
              {hideSubmitButton && (
                <TouchableOpacity style={{flex: 1, alignItems: 'flex-end', height: 40}} onPress={this._submitSelection}>
                  <Icon
                    name="menu-up"
                    style={[
                      styles.indicator,
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      name={hideSubmitButton ? 'menu-down' : 'menu-down'}
